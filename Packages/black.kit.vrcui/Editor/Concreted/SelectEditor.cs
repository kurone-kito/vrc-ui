...
{
    /// <summary>
    /// The inspector of the <see cref="Select"/>.
    /// </summary>
    [CustomEditor(typeof(Select))]
    public class SelectEditor : SelectEditorBase<Select>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawUdonEvent(T.USAGE_DECREMENT);
            DrawUdonEvent(T.USAGE_INCREMENT);
            EditorGUILayout.EndVertical();
            base.OnInspectorGUI();

            serializedObject.Update();
            var (values, index, size) = GetArrayProperty(
                Select.NAME_VALUES, TypedTarget.Index);
